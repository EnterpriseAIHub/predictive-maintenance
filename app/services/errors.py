...
Kept distinct from app.ml.inference.ModelNotFoundError — that one is
an ML-layer concern (no model artifact available); these are business
concerns the API layer (Phase 8) will map to specific HTTP status
codes.
"""
